...
class MovieTest < ActiveSupport::TestCase
  ...
  context "Arguments" do
    ...
    should "have correct imdb votes" do
      assert_in_delta 10520, @movie.imdb_votes, 10
    end
  ...
  context "relationships" do
    ...
    should_validate_numericality_of :imdb_votes 
    should_validate_numericality_of :rating
    should_validate_numericality_of :year
    should_have_named_scope :most_voted, :order => "movies.imdb_votes desc"
